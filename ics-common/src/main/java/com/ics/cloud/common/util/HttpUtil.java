...
public class HttpUtil {
    ...
    public static String postJson(String url, String postData, HttpHeaders httpHeaders) {
        ...
        try {
            ...
            HttpEntity<String> httpEntity = new HttpEntity<String>(postData, httpHeaders);
     ...
     * @return
     */
    public static ReqParamBean getReqParam(HttpServletRequest req) {
        ...
        reqParamBean.setKey(optkey);
        reqParamBean.setParameterJson(paramStr.toString());
        return reqParamBean;
